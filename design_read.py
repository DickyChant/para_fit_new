...
def get_data(hdf_file,path=''):
    if isinstance(hdf_file,h5py._hl.dataset.Dataset):
        ...
        os.rmdir(path_1)
        path_1=path_1+'.txt'
        print (hdf_file.dtype)
        if hdf_file.dtype=='float64':
...
model=h5py.File('/Users/dickie/codes/para_fit_new/model/design.hdf','r')
groups_1=[]

get_data(model,'/Users/dickie/codes/para_fit_new/model/design_data')